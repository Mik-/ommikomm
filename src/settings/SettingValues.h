...
const contrastItem Contrasts[maxContrasts] = { { FL_WHITE, FL_BLACK }, {
		FL_GRAY, FL_BLACK }, { FL_BLACK, FL_GRAY }, { FL_BLACK, FL_WHITE }, {
		FL_BLUE, FL_YELLOW } };

const int maxFonts = 6;

const Fl_Font Fonts[maxFonts] = { FL_HELVETICA, FL_HELVETICA_BOLD, FL_TIMES,
		FL_TIMES_BOLD, FL_COURIER, FL_COURIER_BOLD };

const int maxLinecounts = 4;

const int Linecounts[maxLinecounts] = { 1, 2, 3, 4 };
